...
import joblib
import numpy as np
from model.pipeline import train_classification_model, train_regression_model, plot_left_rate_by_projects, evaluate_classification_model
from model.predictor import predict_attrition  # Import the prediction function
